...
NEXT_ACTION: **新科目「初等考試」已轉檔完成（2026-09-13）：385 卷、18,710 題、102～115 年**，全站現為 2,921 卷／139,271 題，已寫詳解 123,768 題。**下一步＝逐卷寫初等考試的詳解，由新到舊（115 年 27 卷 → 114 年 28 卷 → …→ 102 年 30 卷）。**
...
　**下一步＝110 年**（`e031` 起由大到小共 26 卷），再往 109、108…一路到 102 年。110 年起多了 `e015` 貨幣銀行學大意、`e016` 保險學大意兩科。
