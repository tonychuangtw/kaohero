...
NEXT_ACTION: **114～108 年全部完成；107 年三等（a*）、四等（b*）已完成，五等做到 c016**（地特 468/774 卷、15,182/27,010 題、56.2%）。下一步：**107 五等 `loc-107-1-c017` 稅務法規大意**，再依序 c018 統計學、c019 資料處理、c020 會計學、c021 會計審計法規、c023 土地法、c024 土地行政、c025 中文圖書分類編目、c026 圖書館學、c027 公務員法，以及補完 c002（45/50）。107 做完接 106 → 105 → … → 102。每卷流程：讀題 → Write 工具寫 patch JSON 到 scratchpad → tools/set-exp.js --write → tools/build-index.js --write → test/test.js → commit + push。
