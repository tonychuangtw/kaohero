...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115（1,327／1,345）、114（1,184／1,220）、113（1,195／1,220）、**112（1,251／1,315＝95.1%）皆已完成**——各年剩下的都是圖片缺檔、公式毀損或官方答案有爭議而刻意跳過的題。**現在做 111 年（110／1,315）**：整年只有 g002／p002 法學知識與英文各 45 題已寫，其餘 43 卷全新。建議順序：先高考 g003→g024（21 卷），再普考 p003→p027（22 卷）。111 做完接著 110、109…一路往前到 102。
...
UPDATED: 2026-09-10 台北（115／114／113／112 四個年度完成；下一步 111 年）
