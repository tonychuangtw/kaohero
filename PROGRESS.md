...
　**107 年已全部做完（2026-09-14）**（27 卷），只剩下列刻意跳過的題：`e030` 26 題、`e029` 23 題（電路圖／波形圖題）、`e002` #41～#45（克漏字本文未隨轉檔保留）、`e021` #4 #24（圖形題）、`e017` #6 #17、`e018` #21、`e015` #46（官方答案與教科書衝突）。**下一步＝106 年，由 `e031` 勞工行政與勞工法規大意開始，依序往 e030…e002（共 29 卷）。**做完 106 年再往 105…一路到 102 年。
