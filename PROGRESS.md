...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115、114、113、112、111、110、109、**108 年皆已完成**（各年剩下的都是圖片缺檔、公式毀損、缺文章或官方答案與教科書衝突而刻意跳過的題）。**107 年高考（g001～g021，含國文讀圖 10 題）已全部完成（2026-09-10）**，現在做 **107 年普考**：`gao-107-1-p003` 行政學概要 50 題起，依序到 p027；之後 106…一路往前到 102。
...
UPDATED: 2026-09-10 台北（107 年高考全部完成，高普考 11,047/17,995＝61.4%、全站 75,891/109,281＝69.4%；下一卷 gao-107-1-p003）
