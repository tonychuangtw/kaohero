...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115、114、113、112、111、**110 年皆已完成**（各年剩下的都是圖片缺檔、公式毀損、缺文章或官方答案與教科書衝突而刻意跳過的題）。**現在做 109 年（105／1,265）**：高考 `g003` 行政學 25 起，依序 g004～g021（無 g019）；再做普考 `p003`～`p027`。109 做完接著 108、107…一路往前到 102。
...
UPDATED: 2026-09-10 台北（110 年高普考完成，高普考 46.2%／全站 66.9%；下一卷 gao-109-1-g003 行政學）
