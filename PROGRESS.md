...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題，目前 4,007 題／22.3%）**。115 年 1,327／1,345（98.7%）、114 年 1,184／1,220（97.0%）皆已完成；113 年已完成（1,195／1,220＝98.0%，未寫的 25 題都是圖表毀損、選項毀損或答案有爭議而刻意跳過者）。**現在做 112 年（100／1,315）**，之後依序 111 → 110 → … → 102。每年結構相同：高考 g 系列 20 卷、普考 p 系列 23 卷，共 43 卷。
...
UPDATED: 2026-09-10 台北（115／114／113 三個年度完成，高普考 4,778／17,995＝26.6%）
...
- [ ] **擴充新科目（Tony 2026-09-09 定案的順序）**：現有八類的解析全部做完後，再一科一科加；每加一科就把該科解析寫完，才動下一科。順序：護理師 → 初等考試 → 警察特考 → 導遊領隊 → 其他醫事類（醫檢師、物理治療師、營養師、職能治療師）
  ...
  - 站上「題多解少」的缺口：地方特考 27,010 題只寫了 2,020；高普考 17,995 題已寫 4,778（26.6%；2026-09-09～10 這輪從 1,406 一路推上來）；教師檢定已完成
