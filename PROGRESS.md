...
　**107 年已全部做完（2026-09-14）**（27 卷，略過題見各 commit）。**106 年進行中**（29 卷）：`e031`～`e022` 已完成（e030 26 題、e029 16 題，其餘為電路圖題）。**下一步＝`e021` 經濟學大意，再依序往 e020…e002。**做完 106 年再往 105…一路到 102 年。
