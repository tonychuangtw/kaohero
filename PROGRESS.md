...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題，目前 4,007 題／22.3%）**。115 年 1,327／1,345（98.7%）、114 年 1,184／1,220（97.0%）皆已完成；113 年已完成（1,195／1,220＝98.0%）。**現在做 112 年（601／1,315）**：高考 g 系列已全數完成（只剩 g020 工程數學的圖片題與公式毀損題未寫）；**剩下的是普考 p 系列 23 卷**：`p004`（公共管理概要 25）、`p005`（政治學概要 25）、`p006`（行政法概要 50）、`p007`（地方自治概要 25）、`p008`、`p009`、`p010`、`p011`（移民法規概要 50）、`p012`、`p013`、`p014`（財政學概要 25）、`p015`、`p016`（經濟學概要 50）、`p017`、`p018`（成本與管理會計概要 20）、`p019`（審計學概要 20）、`p020`、`p021`、`p022`（經濟學概要與財政學概要 50）、`p023`（計算機概要 40）、`p024`（有機化學概要 25）、`p027`（計算機概要 40）。112 做完接著 111、110…一路往前到 102。
...
UPDATED: 2026-09-10 台北（115／114／113 完成；112 做到 601／1,315，高考卷已全完）
