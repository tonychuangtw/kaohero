...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115、114、113、112、111、**110 年皆已完成**（各年剩下的都是圖片缺檔、公式毀損、缺文章或官方答案與教科書衝突而刻意跳過的題）。**109 年（高考 g003～g021、普考 p003～p027）已全部完成（2026-09-10）**，**108 年（高考＋普考）已全部完成（2026-09-10）**，現在做 **107 年**：先高考 `gao-107-1-g003` 起，再普考；之後 106…一路往前到 102。
...
UPDATED: 2026-09-10 台北（108 年全部完成，高普考 10,608/17,995＝58.9%、全站 75,452/109,281＝69.0%；下一卷 gao-107-1-g003）
