...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115、114、113、112、111、**110 年皆已完成**（各年剩下的都是圖片缺檔、公式毀損、缺文章或官方答案與教科書衝突而刻意跳過的題）。**109 年（高考 g003～g021、普考 p003～p027）已全部完成（2026-09-10）**，**108 年高考 g003～g021 已完成（2026-09-10）**，現在做 **108 年普考** `gao-108-1-p003` 起；之後 107…一路往前到 102。
...
UPDATED: 2026-09-10 台北（108 年高考完成；下一卷 gao-108-1-p003 行政學概要）
