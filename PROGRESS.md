...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115（98.7%）、114（97.0%）、113（98.0%）、112（95.1%）、111（97.6%）已完成；**110 年高考 g002～g024 全數寫完（2026-09-10）**。**現在做 110 年普考**：`p003` 行政學概要 50 起，依序 p004～p027（含 `p025` 動物解剖生理學概要 50），`p002` 法學知識與英文已有 45 題。110 做完接著 109、108…一路往前到 102。
...
UPDATED: 2026-09-10 13:19 台北（110 年高考完成，高普考 42.1%、全站 66.3%；下一卷 gao-110-1-p003）
