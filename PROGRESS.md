...
NEXT_ACTION: **新科目「初等考試」已轉檔完成（2026-09-13）：385 卷、18,710 題、102～115 年**，全站現為 2,921 卷／139,271 題，已寫詳解 122,607 題。**下一步＝逐卷寫初等考試的詳解，由新到舊（115 年 27 卷 → 114 年 28 卷 → …→ 102 年 30 卷）。**
...
　**下一步＝111 年**（`e031` 勞工行政與勞工法規大意起，由大到小共 33 卷），再往 110、109…一路到 102 年。111 年每卷 40～50 題，一次讀 25 題分兩批即可。
