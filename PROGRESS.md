...
　**114 年進行中**：已完成 `e007` `e008` `e010` `e011` `e012` `e013` `e014` `e018` `e019` `e020` `e021` `e022` `e023` `e024` `e025`，**尚未寫的是 `e026`～`e035`**（公務員法、交通行政、運輸學、電子學、基本電學、勞工行政、臺灣原住民族史、原住民族行政及法規、地方自治、戶籍法規）。114 年做完往 113 年推。
