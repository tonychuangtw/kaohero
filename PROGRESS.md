...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115（98.7%）、114（97.0%）、113（98.0%）、112（95.1%）、**111（97.6%）皆已完成**——各年剩下的都是圖片缺檔、公式毀損或官方答案有爭議而刻意跳過的題。**現在做 110 年**：高考 g003～g011 已完成（g007 稅務法規、g008 財政學、g009 租稅各論、g010 會計學、g011 中級會計學於 2026-09-10 寫完），**下一卷是 `gao-110-1-g012` 政府會計（會計組）25 題**，之後 g013→g024、普考 p003→p027（23 卷，含 `p025` 動物解剖生理學概要 50），每年只有 g002／p002 法學知識與英文已有 39～45 題。110 做完接著 109、108…一路往前到 102。
...
UPDATED: 2026-09-10 台北（110 年高考 g003～g011 完成；下一卷 g012 政府會計）
