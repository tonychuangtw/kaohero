...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115、114、113、112 四個年度已完成；**111 年高考 g 系列全數完成**（591／1,315＝44.9%）。**現在做 111 年普考**，依序：`p003` 行政學概要 50、`p004` 公共管理概要 25、`p005` 政治學概要 25、`p006` 行政法概要 50、`p007` 地方自治概要 25、`p008` 社會政策與社會立法概要 25、`p009` 社會工作概要 25、`p010` 國籍與戶政法規概要 25、`p011` 移民法規概要 50、`p012` 民法概要 25、`p013` 稅務法規概要 25、`p014` 財政學概要 25、`p015` 會計學概要 20、`p016` 經濟學概要 50、`p017` 政府會計概要 20、`p018` 成管會概要 20、`p019` 審計學概要 20、`p020` 衛生行政學概要 25、`p021` 圖書資訊學概要 25、`p022` 經濟學概要與財政學概要 50、`p023` 計算機概要 40、`p024` 有機化學概要 25、`p027` 計算機概要 40。111 做完接著 110、109…一路往前到 102。
...
UPDATED: 2026-09-10 台北（115／114／113／112 完成；111 高考完成，開始普考）
