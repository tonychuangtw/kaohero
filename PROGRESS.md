...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115（1,327／1,345）、114（1,184／1,220）、113（1,195／1,220）、112（1,251／1,315）皆已完成——各年剩下的都是圖片缺檔、公式毀損或官方答案有爭議而刻意跳過的題。**現在做 111 年**：已完成 `g003` 行政學、`g004`＋`g017` 行政法、`g005` 經濟學、`g006` 民法（財稅）、`g007` 稅務法規、`g008` 財政學、`g009` 租稅各論、`g010` 會計學、`g021` 民法（公平會）。**接下來依序**：`g011` 中會 20、`g012` 政府會計 25、`g013` 成管會 25、`g014` 審計學 25、`g015` 會計審計法規 25、`g018` 經濟學概論與財政學概論 20、`g020` 工程數學 20、`g022` 租稅法 25、`g023` 納保法及稅捐稽徵法 25、`g024` 海洋事務總論 25；再做普考 `p003`～`p027`（22 卷）。111 做完接著 110、109…一路往前到 102。
...
UPDATED: 2026-09-10 台北（115／114／113／112 完成；111 高考做到 g010）
