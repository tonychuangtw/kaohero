...
NEXT_ACTION: **新科目「初等考試」已轉檔完成（2026-09-13）：385 卷、18,710 題、102～115 年**，全站現為 2,921 卷／139,271 題，已寫詳解 121,537 題。**下一步＝逐卷寫初等考試的詳解，由新到舊（115 年 27 卷 → 114 年 28 卷 → …→ 102 年 30 卷）。**
...
　**下一步＝112 年**（`e031` 起由大到小），再往 111、110…一路到 102 年。112 年以前每卷仍多為 50 題，111 年以前部分科目為 80 題，讀題要分兩批。
