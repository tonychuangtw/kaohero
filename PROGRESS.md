...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115、114、113、112、111、**110 年皆已完成**（各年剩下的都是圖片缺檔、公式毀損、缺文章或官方答案與教科書衝突而刻意跳過的題）。**109 年高考 g003～g021 已全數完成（2026-09-10）**。**109 年普考 p003～p011 已完成（2026-09-10）**，接著做 `p012` 民法概要，依序到 p027。109 做完接著 108、107…一路往前到 102。
...
UPDATED: 2026-09-10 台北（109 普考 p003～p011 完成；下一卷 gao-109-1-p012 民法概要）
