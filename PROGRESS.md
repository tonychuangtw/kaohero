...
NEXT_ACTION: **主線＝高普考（`gao-*`，633 卷 17,995 題）**。115～106 年皆已完成（各年剩下的都是圖片缺檔、公式毀損、缺克漏字文章或官方答案與法條／教科書衝突而刻意跳過的題）。現在做 **105 年**：`gao-105-1-g003` 行政學 25 題起，依序 g003～g019、再 p003～p027；之後 104…一路往前到 102，最後做地方特考（`loc-*`）。
...
UPDATED: 2026-09-10 台北（106 年全部完成；下一卷 gao-105-1-g003）
