...
window.APP_EXAM_PAPERS['chu-111-1-e002'] = {
 ...
 "qs": [
  ...
  },
  {
   ...
   "a": 1,
   "exp": "✅ (B) 共享單車須付費租用，未付費者被排除在外，具可排他性；而在車輛數量未達飽和前，多一人租用並不減少他人可使用的量，屬共享性（無敵對性），這種「可排他＋共享」的財貨即準公共財（俱樂部財）。\n❌ (A) 獨享性（敵對性）指一人消費即減少他人可消費的數量，如食物、衣服等私有財；共享單車系統在容量內不具此特性。\n❌ (C) 使用前須解鎖付費，業者能有效排除不付費者，並非不可排他。\n❌ (D) 同時具不可排他與共享才是純公共財（如國防、路燈），共享單車有收費機制，不符合。\n📚 出處：公民與社會．財貨分類（以排他性與敵對性劃分私有財、公共財、準公共財、共有資源）"
  },
  {
   "n": 36,
   "pt": 1,
