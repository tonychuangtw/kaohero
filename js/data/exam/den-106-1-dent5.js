...
window.APP_EXAM_PAPERS['den-106-1-dent5'] = {
 ...
 "qs": [
  ...
  },
  {
   ...
   "exp": "✅ (B) 小圓圈指的是支架組織面（內側）上、網狀固位區與研磨過的金屬支架交界的那條線，也就是內終接線（internal finish line）。它位於樹脂基底與金屬相接處的內面，與外終接線上下相對，作用是讓壓克力樹脂能順著這條界線包覆固位網，並在內面形成足夠厚度、不致過薄而斷裂。\n❌ (A) 模型止位是支架上特意做出、直接接觸模型硬組織的小平台，用來防止支架在充填壓克力或使用時下沉變形，位置在網狀固位區內而非交界線上。\n❌ (C) 外終接線是同一交界線在支架外側（拋光面、可見面）的那條線，是臨床上看得到的金屬與樹脂接縫，方向與圖中所指的內面線條相反。\n❌ (D) 輔助性鉤靠是加在其他牙齒上的額外咬合面或舌側靠面，用來分散力量或提供支撐，屬於靠面構造，不是支架與樹脂的交界線。\n📚 出處：McCracken's Removable Partial Prosthodontics，支架構造與終接線（finish line）章節"
  },
  {
   "n": 30,
   "pt": 1,
  ...
  },
  {
   ...
   "exp": "✅ (B) 由咬合面觀察，此修形後牙冠周圍的肩台（margin）寬窄明顯不一致：近心與舌側可見較寬的白色帶狀肩台，頰側與遠心處則幾乎看不到，代表車針深度控制不均，這是本圖最明顯的缺點。肩台寬窄不一會使修復物邊緣厚度不均，薄處易破裂、厚處易過度突出並刺激牙齦。\n❌ (A) 圖中由咬合面觀看主要呈現的是邊緣與外形，近遠心兩側牆的錐狀夾角（taper）在此視角並不能判讀，也看不出有過度外擴的情形。\n❌ (C) 加平行溝是固位性不足時的補強手段，但本圖無法從咬合面判斷軸壁高度與固位性，且固位問題並非圖中最明顯可見的缺失。\n❌ (D) 咬合面的修形大致仍順著牙齒原有的方形外形與尖窩走向，並未出現削成平面或外形完全走樣的情形。\n📚 出處：Shillingburg, Fundamentals of Fixed Prosthodontics，全冠牙體修形與邊緣（margin）設計章節"
  },
  {
   "n": 48,
   "pt": 1,
