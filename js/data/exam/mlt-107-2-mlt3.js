...
window.APP_EXAM_PAPERS['mlt-107-2-mlt3'] = {
 ...
 "qs": [
  ...
  },
  {
   ...
   "a": 1,
   "fig": "img/q/107100_308_55_51.webp",
   "exp": "✅ (B) 鹼性電泳中 CK 同功酶由陽極往陰極依序為 CK-1（BB）、CK-2（MB）、CK-3（MM）。圖中除了正常血清本來就佔絕大多數的 CK-3（MM）之外，還出現一個明顯的 CK-2（MB）波峰；正常人 CK-MB 僅佔總 CK 約 6% 以下、電泳上幾乎看不到。CK-MB 主要存在於心肌，明顯增高代表心肌細胞壞死釋出，故最可能為急性心肌梗塞。\n❌ (A) 肌肉萎縮症（如 Duchenne 型）破壞的是骨骼肌，總 CK 雖大幅上升但以 CK-3（MM）為主，不會出現這麼明顯的 CK-2 波峰。\n❌ (C) 腎衰竭時 CK 多為輕度上升且以 MM 型為主，主要異常指標是 BUN、creatinine，非 CK-MB 分離出現。\n❌ (D) 急性肝炎肝細胞幾乎不含 CK，血中升高的是 ALT、AST 等轉胺酶，CK 同功酶電泳不會出現 CK-2 增高。\n📚 出處：臨床生化學「肌酸激酶（CK）同功酶與心肌損傷標記」章節；CK-MB 電泳判讀"
  },
  {
   "n": 52,
   "pt": 1,
