...
window.APP_EXAM_PAPERS['gao-112-1-p023'] = {
 ...
 "qs": [
  ...
  },
  {
   ...
   "a": 2,
   "note": "⚠ 官方公布答案是 (C)，與網路通訊通用教科書的敘述衝突。\nOSI 模型中，資料連結層的功能一般列為框裝、實體定址、流量控制、錯誤控制與存取控制，流量控制確實包含在內（傳輸層另有端對端的流量控制，兩層並不互斥），因此 (C) 並非錯誤敘述；其餘 (A)(B)(D) 也都與通說相符。\n本題答案有爭議，建議兩種說法都記下，考場上再依命題脈絡取捨。"
  },
  {
   "n": 34,
   "pt": 1,
